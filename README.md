...
3) Radiation domination and decaying turbulence from N=6.44 to N=10.34 (orange). The peak scale continues to shift toward smaller wavenumbers.
4) Dynamo amplification followed by decaying turbulence from N=10.34 onward (red).
   With the onset of dynamo action, the magnetic field undergoes renewed amplification, temporarily reversing its decay. It subsequently resumes decaying in the freely decaying turbulent regime.
